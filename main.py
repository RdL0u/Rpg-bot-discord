...
COLUNAS_ATRIBUTOS = set(
    ATRIBUTOS.keys()
)

COLUNAS_PERICIAS = set(
    PERICIAS.keys()
)
...
async def definirmestre(
    ...
    await interaction.response.send_message(
        ...
        f"👹 Os NPCs existentes também foram atribuídos ao Mestre."
...
async def passarmestre(
    ...
    await interaction.response.send_message(
        ...
        f"👹 Os NPCs foram transferidos para o novo Mestre."
...
async def criarficha(
    ...
    await interaction.response.send_message(
        ...
        f"Use `/atributo` e `/pericia` para configurar sua ficha."
...
# ============================================================
# ALTERAR ATRIBUTO
# JOGADOR ALTERA O PRÓPRIO
# MESTRE PODE ALTERAR DE OUTRO JOGADOR
# ============================================================
...
async def atributo(
    ...
    if jogador is None:
    ...
    elif jogador.id != interaction.user.id:
        ...
        if (
            ...
            await interaction.response.send_message(
                "❌ Somente o Mestre pode alterar a ficha de outro jogador.",
                ephemeral=True
            )
    ...
    await interaction.response.send_message(
        ...
        f"{ATRIBUTOS[coluna][1]}: {valor}"

    )


# ============================================================
# ALTERAR ATRIBUTO DE NPC
# ============================================================
...
# ============================================================
# ALTERAR PERÍCIA
# JOGADOR ALTERA A PRÓPRIA
# MESTRE PODE ALTERAR OUTRO JOGADOR
# ============================================================
...
# ============================================================
# CURAR JOGADOR
# QUALQUER JOGADOR PODE CURAR OUTRO JOGADOR
# ============================================================
...
# ============================================================
# CURAR NPC
# QUALQUER JOGADOR PODE CURAR NPC
# ============================================================
...
# ============================================================
# RECUPERAR MANA DE JOGADOR
# QUALQUER JOGADOR PODE RECUPERAR OUTRO
# ============================================================
...
async def apagarficha(
    ...
    await interaction.response.send_message(
        ...
        f"🗑️ Sua ficha **{f['nome']}** foi apagada."
...
async def help(
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`/recuperarmana` — Recuperar Mana de jogador\n"
            "`/recuperarmanpc` — Recuperar Mana de NPC\n"
            "`/addxp` — Adicionar XP"
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`/criarnpc` — Criar NPC\n"
            "`/npcs` — Ver NPCs\n"
            "`/atributo` — Alterar atributo de jogador\n"
            "`/pericia` — Alterar perícia de jogador\n"
